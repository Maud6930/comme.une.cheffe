...
const Home: React.FC = () => {
  return (
    <div className="bg-gray-100 font-sans leading-normal tracking-normal">
      <Header />
      <main className="container mx-auto px-6 py-20 flex gap-10 flex-col">
        ...
        <Section id="Cheffe" title="Formule : I became a cheffe." className="bg-white text-gray-800 rounded-lg shadow-md p-6">
          <div className="course-description">
            <p className="text-gray-800 text-xl mb-6">
        ...
        <Section id="entrepreneur" title="Formule : pour ouvrir ton commerce." className="bg-white text-gray-800 rounded-lg shadow-md p-6">
          <div className="course-description">
            <p className="text-gray-800 text-xl mb-6">
